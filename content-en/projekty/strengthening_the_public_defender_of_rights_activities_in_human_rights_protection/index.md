...
<p>April 22, 2024 - as part of the defender&#39;s activities, which are aimed at greater comprehensibility of the written outputs of the public administration, we are publishing the Final Report from the conducted research testing the comprehensibility of the outputs of the Public Defender of Rights.</p>

<p>March 4, 2024 - we publish the <a href="accessibility_of_public_buildings_and_services_to_people_with_disabilities.pdf">final report from the research</a>, which focused on the accessibility of public buildings and services in individual regional towns. People with disabilities directly verified the accessibility of selected branches of the Czech Social Security Administration, the Czech Post Office, regional hospitals, the labor office, the court, but also public transport or the websites of the visited authorities. None of the tested institutions fully meets the requirements for accessibility for people with visual, hearing or physical disabilities. Research entitled Accessibility of Public Buildings and Services to People with Disabilities showed that the level of accessibility and the number of obstacles differ for individual types of disabilities. The most accessible buildings are for people with physical disabilities. On the contrary, people with hearing impairment have to overcome the biggest barriers.</p>

<p>March 1, 2024 &ndash; we are publishing the final report from the research <a href="deinstitutionalisation_and_transformation_of_social_services_-_survey_report.pdf">Deinstitutionalisation and transformation of social services</a>, when the protector mapped how the process of deinstitutionalization and transformation of social services for people with disabilities is taking place. He focused primarily on how regions not only define these processes, but also on how they directly involve people with disabilities in planning the transformation of institutions. The research, entitled Deinstitutionalization and Transformation of Social Services, consisted of a content analysis of the medium-term plans of social services of the regions and also in interviews with representatives of the regions.</p>
...
<p>January 17, 2024 - we publish <a href="how_to_avoid_workplace_discrimination_-_recommendations_for_employers.pdf">Recommendations for employers &ndash; How to avoid discrimination in the workplace</a>, as well as the related practical guide<a href="the_most_frequent_cases_of_workplace_discrimination_and_how_to_avoid_them_-_practical_guide.pdf">The most frequent cases of workplace discrimination and how to avoid them</a>, and we also bring insights from fulfilling the right to equal treatment and protection against discrimination for the year 2023 in the monitoring report <a href="implementation_of_the_right_to_equal_treatment_and_protection_against_discrimination_-_final_report.pdf">Implementation of the Right to Equal Treatment and Protection against Discrimination</a>.</p>

<p>January 1, 2024 - we are publishing a research report&nbsp;<a href="good_practice_in_the_provision_of_housing_to_vulnerable_people_-_survey_report.pdf">Good Practice in the Provision of Housing to Vulnerable People</a>. Using research, we decided to find examples of good practice in providing housing across regions and different target groups. In this way, we want to contribute to a better awareness of what is successful and working, but also to name the shortcomings that the state should solve in the future.</p>
...
<ul>
	...
	<li>December 15, 2023 &ndash; &nbsp;following the Office&#39;s partnership with the Norwegian national human rights institution - Norges institusjon for menskerettigheter, we present an up-to-date view of the establishment of a national human rights institution in the Czech Republic. You can read the article <a href="establishment_of_an_nhri_in_the_czech_republic_article.docx">here</a>.</li>
	<li>December 14, 2023 &ndash;&nbsp; we are publishing the twentieth report from the follow-up visit to the facility from the Radkov &ndash; Dubová Children&#39;s Home <a href="https://www.ochrance.cz/uploads-import/ESO/33_2022_NZ%20DD%20Radkov%20Final.pdf">here</a>.</li>
	<li>November 30, 2023 &ndash; we realized the workshop My life, my choice, or self-determination, where we presented the preliminary results of research on the topic of deinstitutionalization, which maps the approach of regions and the Ministry of Labor and Social Affairs in the context of fulfilling the rights of people with disabilities. You can see the workshop presentation <a href="11_30_muj_zivot_moje_volba_aneb_sebeurceni_prezentace.pdf">here</a>.</li>
...
<ul>
	...
	<li>November 22, 2023 &ndash; we are publishing the sixteenth report from the follow-up visit to the Žulová Educational Institution <a href="https://www.ochrance.cz/uploads-import/ESO/13_2023_NZ%20V%C3%9A%20%C5%BDulov%C3%A1.pdf">here</a> and the seventeenth report from the follow-up visit to the police cell of the district department of Litoměřice <a href="https://www.ochrance.cz/uploads-import/ESO/Zpr%C3%A1va%20NZ%2016-2023%20Litom%C4%9B%C5%99ice.pdf">here</a>.</li>
...
<ul>
	...
	<li>
	<p>June 22, 2023 - we held a Parenting at the Workplace workshop for the general public. The aim of the workshop was to present findings from research on Pregnancy and Maternity at the Workplace. Here you can see the <a href="06_22_rodicovstvi_na_pracovisti_prezentace_1_.pdf">presentation on the research report</a>, the <a href="06_22_rodicovstvi_na_pracovisti_prezentace_2_.pdf">presentation on the recommendations</a>,&nbsp; the <a href="06_22_rodicovstvi_na_pracovisti_prezentace_3_.pdf">presentation on the practical guide</a> and the <a href="06_22_rodicovstvi_na_pracovisti_prezentace_4_.pdf">presentation on the case studies</a>.</p>
	</li>
	<li>
