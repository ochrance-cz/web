    ...
    d &&
      ...
      c ||
        a.each(d.options.keyBindings, function (c, e) {
          return e &&
            a.isFunction(e.fn) &&
            (('number' == typeof e.key && b.which === e.key) || ('string' == typeof e.key && b.key === e.key))
    ...
    (a.jPlayer.prototype = {
            ...
            {},
            {
              ...
              swf:
                ...
                ('.swf' !== this.options.swfPath.toLowerCase().slice(-4)
                  ? (this.options.swfPath && '/' !== this.options.swfPath.slice(-1) ? '/' : '') + 'jquery.jplayer.swf'
                  : ''),
            }
          )),
        ...
        this.html.video.available &&
          ...
          this.status.nativeVideoControls && this.require.video
            ...
            : this.status.waitForPlay &&
              this.status.video &&
              (this.internal.poster.jq.show(), this.internal.video.jq.css({ width: '0px', height: '0px' })));
      },
      _addHtmlEventListeners: function (b, c) {
        ...
        (b.preload = this.options.preload),
          ...
          this.status.playbackRateEnabled &&
            ((b.defaultPlaybackRate = this.options.defaultPlaybackRate), (b.playbackRate = this.options.playbackRate)),
          b.addEventListener(
            'progress',
            function () {
              c.gate &&
      ...
      _getHtmlStatus: function (a, b) {
        ...
        isFinite(a.duration) && (this.status.duration = a.duration),
          ...
          'object' == typeof a.seekable && a.seekable.length > 0
            ? ((e =
                this.status.duration > 0 ? (100 * a.seekable.end(a.seekable.length - 1)) / this.status.duration : 100),
      ...
      _getAuroraStatus: function (a, b) {
        ...
        (this.status.duration = a.duration / 1e3),
          ...
          (d = this.status.duration > 0 ? (100 * c) / this.status.duration : 0),
          a.buffered > 0
            ? ((e = this.status.duration > 0 ? (a.buffered * this.status.duration) / this.status.duration : 100),
          ...
          d
            ? ((this.status.nativeVideoControls && this.html.video.gate) ||
              ...
              'string' == typeof b.title &&
                ...
                this.htmlElement.video && this.htmlElement.video.setAttribute('aria-label', b.title)),
      ...
      mutedWorker: function (b) {
        (this.options.muted = b),
          ...
          this.html.video.gate ||
            ...
            (this._updateMute(b), this._updateVolume(this.options.volume), this._trigger(a.jPlayer.event.volumechange));
      },
      mute: function (a) {
        ...
        (this.options.cssSelectorAncestor = b),
          ...
          b &&
            ...
            this._warning({
              ...
              context: b,
              message:
                a.jPlayer.warningMsg.CSS_SELECTOR_COUNT + this.ancestorJq.length + ' found for cssSelectorAncestor.',
          ...
          if (a.jPlayer.prototype.options.cssSelector[b]) {
            ...
            c &&
              ...
              this._warning({
                ...
                message:
                  a.jPlayer.warningMsg.CSS_SELECTOR_COUNT + this.css.jq[b].length + ' found for ' + b + ' method.',
                hint: a.jPlayer.warningHint.CSS_SELECTOR_COUNT,
              });
          } else
            this._warning({
