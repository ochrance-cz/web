...
perex: V novém prázdninovém podcastu se posluchači dozví, jak funguje poplatek z
  pobytu z obou stran, tedy z pozice poplatníka, kterým je typicky turista, i z
  pozice plátce, kterým je ubytovatel. Řekneme si, co je potřeba hlásit, co
  vyplňovat a kde zjistit informace. Poplatek dopadá i na služby typu AirBnB,
  což je přirozený můstek k tématu sdílené ekonomiky. Stručně shrnujeme
  povinnosti osob, které se do sdílené ekonomiky, nebo služeb, které se za ni
  maskují, zapojili.
---
...
<p>Další podcast bude za dva týdny, v&nbsp;pátek 27. 8. a bude se věnovat vzdělávání dětí s&nbsp;postižením. Následně budeme celé září pokračovat podcasty na téma školství opět v týdenní frekvenci, každý pátek.</p>
